...
class ResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String severity = getAnxietySeverity(totalScore);
    String description = getAnxietyDescription(totalScore);
    double progress = totalScore / 21.0; // Normalized score (0 to 1)

    return Scaffold(
      appBar: AppBar(title: Text("Your Anxiety Level")),
      body: Padding(
